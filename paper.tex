...
% Trying to typeset code
\usepackage{newfloat}
\DeclareFloatingEnvironment[
    fileext=loc,
    listname={List of Code Samples},
    name=Code,
    placement=tbhp,
    within=none,
]{code}
