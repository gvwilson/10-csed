...
\cite{guzdial-myths} refers to the belief that some people are born programmers and others aren't
...
The most powerful evidence for this comes from \cite{patitsas-bimodal}.
...
\item Instructors can spend too much time typing in boilerplate code
  ...
  intended thrust of a lesson.  As \cite{willingham-book} says,
...
\cite{morrison-subgoals,morrison-parsons,margulieux} have shown that students perform better
...
\cite{bouvier-context} examined this with a multi-university study
